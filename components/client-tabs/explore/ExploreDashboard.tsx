...
const s = StyleSheet.create({
  ...
  liveDot: { width: 6, height: 6, borderRadius: 3, borderCurve: 'continuous', backgroundColor: C.accent },
  ...
  thumb: { width: 64, height: 48, borderRadius: 10, borderCurve: 'continuous', backgroundColor: C.borderMuted },
