  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      Animated.parallel([
        ...
        Animated.spring(vaultTranslateY, {
          toValue: 0,
          friction: 6,
          tension: 40,
          useNativeDriver: true,
    ...
    <View style={styles.container}>
        ...
        <Animated.View
          ...
          style={[
            styles.particle,
            {
              ...
              bottom: '-10%',
              transform: [{
                translateY: p.interpolate({ inputRange: [0, 1], outputRange: [0, -600] })
              }],
      ...
      <View style={styles.cardLayer} pointerEvents="none">
        ...
        <View style={styles.statsContainer}>
          <Animated.Text style={[styles.statText, { opacity: stat1Opacity }]}>
            ✓ {plan.name} Activated
          </Animated.Text>
          <Animated.Text style={[styles.statText, { opacity: stat2Opacity }]}>
            ✓ FitLink Pass Journey Unlocked
          </Animated.Text>
          <Animated.Text style={[styles.statText, { opacity: stat3Opacity }]}>
            ✓ Direct Coach Messaging Enabled
          </Animated.Text>
        </View>
      </View>
