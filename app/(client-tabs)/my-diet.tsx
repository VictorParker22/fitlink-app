          ...
          <>
            ...
            <LinearGradient colors={isDark ? ['#1A1A24', '#22222E'] : ['#1C1C21', '#2A2A32']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.macroSummary}>
              <View style={styles.macroSummaryLeft}>
                <MacroDonut size={80} cals={globalMacros.cals} protein={globalMacros.protein} carbs={globalMacros.carbs} fat={globalMacros.fat} color={colors} />
                <View style={styles.macroCenter}>
                  <Text style={styles.macroCenterVal}>{globalMacros.cals}</Text>
                  <Text style={styles.macroCenterLabel}>kcal</Text>
                </View>
              </View>
              <View style={styles.macroBreakdown}>
                <View style={styles.macroItem}>
                  ...
                  <View>
                    <Text style={styles.macroItemVal}>{globalMacros.protein}g</Text>
                ...
                <View style={styles.macroItem}>
                  ...
                  <View>
                    <Text style={styles.macroItemVal}>{globalMacros.carbs}g</Text>
                ...
                <View style={styles.macroItem}>
                  ...
                  <View>
                    <Text style={styles.macroItemVal}>{globalMacros.fat}g</Text>
        ...
        renderItem={({ item: diet }) => {
          ...
          return (
            <Card style={styles.dietCard}>
              <TouchableOpacity onPress={() => setExpandedId(isExpanded ? null : diet.id)} activeOpacity={0.8}>
                    ...
                    return (
                      <View key={i} style={styles.timelineRow}>
                        ...
                        <View style={[styles.timelineContent, !isLast && { paddingBottom: Spacing.lg }]}>
                          ...
                          <Text style={styles.timelineMealName}>{meal.name}</Text>
...
const getStyles = (colors: ThemeColors, isDark: boolean) => StyleSheet.create({
  ...
  sectionTitle: { fontFamily: FontFamily.headingSemiBold, fontSize: FontSize.sm, color: colors.textTertiary, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: Spacing.lg, marginBottom: Spacing.md },

  // Macro summary hero
  macroSummary: { borderRadius: Radius.xl, padding: Spacing.lg, flexDirection: 'row', alignItems: 'center', gap: Spacing.xl },
  ...
  macroItemVal: { fontFamily: FontFamily.headingSemiBold, fontSize: FontSize.base, color: '#FFF' },
  ...
  dietIconBox: { width: 44, height: 44, borderRadius: Radius.md, alignItems: 'center', justifyContent: 'center' },
  dietName: { fontFamily: FontFamily.bodySemiBold, fontSize: FontSize.md, color: colors.textPrimary },
  dietMeta: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: colors.textTertiary, marginTop: 2 },

  quickMacros: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm, marginTop: Spacing.md },
  quickMealPill: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 5, borderRadius: Radius.full },
  quickMealText: { fontFamily: FontFamily.bodySemiBold, fontSize: 10, textTransform: 'capitalize' },
  quickMore: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: colors.textTertiary, alignSelf: 'center' },

  // Timeline
  mealsTimeline: { marginTop: Spacing.lg, paddingTop: Spacing.md, borderTopWidth: 1, borderTopColor: colors.border },
  ...
  timelineMealTime: { fontFamily: FontFamily.bodySemiBold, fontSize: FontSize.xs, color: colors.accent, textTransform: 'uppercase', letterSpacing: 0.5 },
  timelineMealName: { fontFamily: FontFamily.headingSemiBold, fontSize: FontSize.base, color: colors.textPrimary, marginTop: 2 },
  timelineMealDesc: { fontFamily: FontFamily.body, fontSize: FontSize.xs, color: colors.textTertiary, marginTop: 4, lineHeight: 16 },
